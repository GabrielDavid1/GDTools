  ...
  return (
    <section className="side-area">
      ...
      <div className="information"> 
        <div> <a href="https://github.com/GabrielDavid1/GDTools"><Github width={15} /></a> </div>
        <div> <a href="https://www.linkedin.com/in/gabrieldavidsilva/"><Linkedin fill="#fff" width={15} /></a> </div>
        <div> <a href="https://wa.me/554898479145"><Whatsapp width={15} /></a> </div>
      </div>
    </section>
  );
}
